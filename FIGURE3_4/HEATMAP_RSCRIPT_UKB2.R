...
ggsave(paste(WorkingDirectory,"Output//plot//FA_hide_unsig.jpeg",sep=""), FA.hide.unsig, width = 8.5, height = 11, units = "in", dpi = 300)
ggsave(paste(WorkingDirectory,"Output//plot//MD_hide_unsig.jpeg",sep=""), MD.hide.unsig, width = 8.5, height = 11, units = "in", dpi = 300)
